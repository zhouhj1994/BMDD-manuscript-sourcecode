...
method.z <- c('BMDD', 'mbDenoise', 'mbImpute', 'SAVER', 'scImpute', 'ALRA', 'DMM',
            'naive-1', 'naive-2', 'naive-3', 'naive-4', 'BMDD.2', 'mbDenoise.2', 'mbImpute.2')
method.u <- c('BMDD', 'mbDenoise', 'mbImpute', 'SAVER', 'scImpute', 'ALRA', 'DMM',
            'naive-1', 'naive-2', 'naive-3', 'naive-4', 'BMDD.2')
...
tab.fun('S2', m, n, a, b, q, r, nsim, method.z, metric, type = 'Theoretical')
tab.fun('S3', m, n, a, b, q, r, nsim, method.z, metric, type = 'Theoretical')
tab.fun('S4', m, n, a, b, q, r, nsim, method.u, metric, type = 'Theoretical')
tab.fun('S5', m, n, a, b, q, r, nsim, method.u, metric, type = 'Theoretical')

tab.fun('S2-2', m, n, a, b, q, r, nsim, method.z, metric, type = 'Theoretical2')
tab.fun('S3-2', m, n, a, b, q, r, nsim, method.z, metric, type = 'Theoretical2')
tab.fun('S4-2', m, n, a, b, q, r, nsim, method.u, metric, type = 'Theoretical2')
tab.fun('S5-2', m, n, a, b, q, r, nsim, method.u, metric, type = 'Theoretical2')

tab.fun('S6', m, n, a, b, q, r, nsim, method, metric, type = 'Correlation')
tab.fun('S7', m, n, a, b, q, r, nsim, method, metric, type = 'Correlation')
tab.fun('S8', m, n, a, b, q, r, nsim, method, metric, type = 'Correlation')
tab.fun('S9', m, n, a, b, q, r, nsim, method, metric, type = 'Correlation')

tab.fun('S10', m, n, a, b, q, r, nsim, method, metric, type = 'Non-parametric')
tab.fun('S11', m, n, a, b, q, r, nsim, method, metric, type = 'Non-parametric')
tab.fun('S12', m, n, a, b, q, r, nsim, method, metric, type = 'Non-parametric')
tab.fun('S13', m, n, a, b, q, r, nsim, method, metric, type = 'Non-parametric')
