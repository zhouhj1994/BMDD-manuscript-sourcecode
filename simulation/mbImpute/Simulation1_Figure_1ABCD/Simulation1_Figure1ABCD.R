...
write.csv(y_sim, "y_sim.csv")
print(max(colMeans(y_sim)))
print(max(colMeans(sim_tab_zi)))
write.csv(sim_tab_zi, "sim_tab_zi.csv")
print(max(rowMeans(sim_tab_zi_trans)))
write.csv(sim_tab_zi_trans, "sim_tab_zi_trans.csv")

write.csv(y_sim_rec, "y_sim_rec.csv")
write.csv(sim_tab_zi_mbImpute, "sim_tab_zi_mbImpute.csv")
