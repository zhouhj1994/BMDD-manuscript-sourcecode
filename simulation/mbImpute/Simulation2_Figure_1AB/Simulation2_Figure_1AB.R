...
write.csv(sim_tab_zi_trans, "code_ocean/sim_tab_zi_trans.csv")
write.csv(sim_tab_zi_mbImpute, "code_ocean/sim_tab_zi_mbImpute.csv")
write.csv(y_sim_rec, "code_ocean/y_sim_rec.csv")
write.csv(sim_tab_zi, "code_ocean/sim_tab_zi.csv")
